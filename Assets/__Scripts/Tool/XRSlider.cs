...
{
    [AddComponentMenu("UI/XRSlider", 33)]
    [ExecuteAlways]
    ...
    /// </remarks>
    public class XRSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        //// Stolen from SetPropertyUtility
